                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control form-control-sm" name="nip" id="nip"
                                placeholder="Masukkan NIP" minlength="16" maxlength="16" required />
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control form-control-sm" name="nama_karyawan"
                                id="nama_karyawan" placeholder="Masukkan Nama Karyawan" required />
                            <ul id="error-list" class="list-unstyled text-danger"></ul>
                        </div>
                        <div class="col-sm-12">
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                        ...
                        <div class="col-sm-12">
                            ...
                            <select class="selectpicker form-control form-control-sm" name="jabatan" id="jabatan"
                                data-live-search="true" title="Pilih Jabatan" required>
