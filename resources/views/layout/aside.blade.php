             ...
             <div class="aside-user-info flex-row-fluid flex-wrap ms-5">
                 ...
                 <div class="d-flex">
                     ...
                     <div class="flex-grow-1 me-2">
                         <!--begin::Username-->
                         <a href="#"
                             class="text-white text-hover-primary fs-7 fw-bold">{{ Auth::user()->name }}</a>
                         <!--end::Username-->
                         <!--begin::Description-->
                         <span class="text-gray-600 fw-bold d-block fs-8 mb-1">{{ Auth::user()->jabatan }}</span>
                         <!--end::Description-->
                         <!--begin::Label-->
                         ...
                         <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                             ...
                             <div class="menu-item px-3">
                                 <div class="menu-content d-flex align-items-center px-3">
                                     ...
                                     <div class="symbol symbol-50px me-5">
                                         <img alt="Logo" src="{{ asset('assets/media/avatars/profil.png') }}" />
                                     </div>
                                     <!--end::Avatar-->
                                     <!--begin::Username-->
                                     <div class="d-flex flex-column">
                                         <div class="fw-bolder d-flex align-items-center fs-7">{{ Auth::user()->name }}
                                             <span
                                                 class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">{{ Auth::user()->jabatan }}</span>
                                         </div>
                                         <a href="#"
                                             class="fw-bold text-muted text-hover-primary fs-8">{{ Auth::user()->email }}</a>
                                     </div>
                                     <!--end::Username-->
                                 </div>
                             </div>
                             ...
                             <div class="menu-item px-5">
                                 <form action="{{ route('logout') }}" class="d-block" method="POST" id="logoutform">
                                     @csrf
                                     <button type="submit" class="btn btn-sm border border-light w-100">Sign
                                         Out</button>
                                 </form>
                             </div>
                             <!--end::Menu item-->
     ...
     <div class="aside-menu flex-column-fluid">
         ...
         <div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
             ...
             <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                 ...
                 @endcan
                 <div class="menu-item">
                     <a class="menu-link {{ Request::routeIs('reimbursement.*') ? 'active' : '' }}"
